...
- Kubernetes cluster (v1.19+) или Docker Desktop с Kubernetes
- kubectl
- NGINX Ingress Controller

#### Автоматическое развертывание и тестирование

Запустите полное развертывание и тестирование одной командой:
...
Этот скрипт:
1. Развертывает все сервисы в Kubernetes
2. Настраивает Ingress
3. Запускает port-forward для тестов
4. Выполняет автоматические тесты API
...
2. Разверните базу данных и Kafka:
```bash
...
После развертывания API доступно по адресу:
- **URL**: `http://127.0.0.1`
- **Host header**: `cinemaabyss.example.com`

Или добавьте в файл hosts:
```
